...
\begin{center}
  ...
  {\large\bfseries Champions Language}\\[1.5em]
    Integrantes:
    Juan Pablo Olave Muñoz, Juan Sebastian López Guzmán, \\
    Cristian Camilo Salazar Arenas \\
    
  Procesadores del Lenguaje 2026-1 \\
  Docente: John Harold Morales Vélez
\end{center}
...
\textbf{Temática:} Lenguaje totalmente basado en los equipos y jugadores que han estado presente en la Champions League, y algunas jergas alrededor de estos. Se hacen referencias a algunas burlas o contextos relevantes alrededor de dichos equipos.

\textbf{Justificación:} Nosotros elegimos el fútbol porque permite mapear la creación de compiladores e interpretes de una manera sencilla y divertida: declarar una variable es ``pasar el balón'', un condicional es una ``jugada de ataque'', un ciclo es una ``repetición'', imprimir es ``gritar gol''. Cada palabra clave tiene una razón futbolística clara, lo que le da identidad y coherencia al lenguaje.
...
ataca\_el\_atleti & \texttt{while}      & El Atlético se queda defendiendo los 90 minutos con reposición del partido. Esto representa un ciclo con condición \\
ataca\_el\_arsenal & \texttt{for}       & Lo mismo que el Atletico pero ahora en ataque. El Arsenal ataca de manera interminable y sin lograr meter ningún gol pero con estructura definida: inicio, condición y actualización \\
...
\bibitem{ocaml}
OCaml Documentation,
``The OCaml 5.4 Reference Manual,''
OCaml, [En línea].
Disponible en: \url{https://ocaml.org/manual/5.4/index.html}
[Consultado: 2026].

\bibitem{atletico}
Quora,
``Is Atletico Madrid the most boring big club in Europe?,''
Quora, [En línea].
Disponible en: \url{https://www.quora.com/Is-Atletico-Madrid-the-most-boring-big-club-in-Europe}
[Consultado: 2026].

\bibitem{ucl}
UEFA,
``UEFA Champions League,''
UEFA Official Site, [En línea].
Disponible en: \url{https://es.uefa.com/uefachampionsleague/}
[Consultado: 2026].
...
Disponible en: \url{https://es.wikipedia.org/wiki/Cristiano_Ronaldo}
[Consultado: 2026].
...
``Kylian Mbappé,''
Wikipedia, La enciclopedia libre, [En línea].
Disponible en: \url{https://es.wikipedia.org/wiki/Kylian_Mbapp\%C3\%A9}
[Consultado: 2026].
